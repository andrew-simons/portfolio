...
function PortfolioVisual() {
  return (
    <div className="w-full h-full relative overflow-hidden flex items-center justify-center" style={{ background:'#0D0B0E' }}>
      <div style={{ position:'absolute', inset:0, background:'radial-gradient(ellipse at 50% 45%, rgba(201,168,76,0.06), transparent 60%)' }} />
      {/* Browser mockup */}
      <div style={{ width:158, height:106, background:'#080612', borderRadius:6, border:'1px solid rgba(201,168,76,0.2)', overflow:'hidden', boxShadow:'0 8px 32px rgba(0,0,0,0.55)' }}>
        <div style={{ height:16, background:'rgba(201,168,76,0.05)', borderBottom:'1px solid rgba(201,168,76,0.09)', display:'flex', alignItems:'center', gap:2.5, padding:'0 7px' }}>
          {['#ff5f57','#febc2e','#28c840'].map((c,i) => (
            <div key={i} style={{ width:5, height:5, borderRadius:'50%', background:c, opacity:0.45 }} />
          ))}
          <div style={{ flex:1, height:6, marginLeft:5, background:'rgba(155,147,144,0.08)', borderRadius:3 }} />
        </div>
        <div style={{ padding:'7px 9px', display:'flex', flexDirection:'column', gap:3 }}>
          <div style={{ height:2.5, width:'28%', background:'rgba(201,168,76,0.38)', borderRadius:2 }} />
          <div style={{ height:2, width:'46%', background:'rgba(155,147,144,0.09)', borderRadius:2 }} />
          <div style={{ display:'flex', gap:6, marginTop:3 }}>
            <div style={{ flex:1, display:'flex', flexDirection:'column', gap:2 }}>
              <div style={{ height:1.5, width:'65%', background:'rgba(155,147,144,0.1)', borderRadius:2 }} />
              <div style={{ height:1.5, width:'48%', background:'rgba(155,147,144,0.07)', borderRadius:2 }} />
            </div>
            <div style={{ width:32, height:32, borderRadius:'50%', background:'rgba(201,168,76,0.04)', border:'1px solid rgba(201,168,76,0.14)', flexShrink:0 }} />
          </div>
          <div style={{ display:'flex', gap:3, marginTop:3 }}>
            {[1,2,3].map(i => (
              <div key={i} style={{ flex:1, height:22, background:'rgba(201,168,76,0.04)', borderRadius:3, border:'1px solid rgba(201,168,76,0.08)' }} />
            ))}
          </div>
        </div>
      </div>
      {/* Floating code hint */}
      <div style={{ position:'absolute', top:10, right:12, fontFamily:'var(--font-code)', fontSize:6, color:'rgba(201,168,76,0.22)', lineHeight:1.8, whiteSpace:'pre' }}>
        {'<motion\n  animate\n  spring />'}
      </div>
    </div>
  )
...
const PROJECTS: Project[] = [
  {
    ...
    repo:'https://github.com/andrew-simons/botswana-drought-flood',
  },
  {
    id:'beaver', title:'Gamified Self-Improvement App', org:'Personal Project',
    subtitle:'Full Stack',
    ...
    demo:'https://questlog-hocl.onrender.com/',
  },
  {
  ...
  },
  {
    ...
    subtitle:"Children's Music Brigade Inc.",
  ...
  {
    id:'portfolio', title:'This Portfolio', org:'Personal Project',
    subtitle:'This Site',
    description:'The site you\'re on, React 19, Framer Motion physics, Three.js, and Tailwind CSS v4. Music-studio theme with audio-reactive animations.',
    accent:'#C9A84C', rotation:-1.8, Visual:PortfolioVisual,
    tags:[{label:'React',type:'web'},{label:'Framer Motion',type:'web'},{label:'Three.js',type:'web'}],
  },
]
    ...
    <div style={{ position:'relative', zIndex: hovered ? 20 : 1 }}>
      ...
      >
        ...
        <div style={{
          ...
          {/* Links — always visible, brighten on hover */}
          {(project.repo || project.demo) && (
            <div style={{
              display:'flex', alignItems:'center', justifyContent:'center',
              gap:6, padding:'0 16px 12px',
            }}>
              {project.demo && (
                <a
                  href={project.demo}
                  ...
                  style={{
                    ...
                    color:`${project.accent}bb`, textDecoration:'none',
...
export function Projects() {
  return (
    <section id="work" className="flex flex-col items-center" style={{ paddingTop: 80, paddingBottom: 80 }}>
      {/* Wall */}
      <motion.div
      ...
      >
        ...
        <div style={{
          ...
          {PROJECTS.map((project, i) => {
            const isLoneLastRow = PROJECTS.length % 3 === 1 && i === PROJECTS.length - 1
            return (
              <motion.div
                key={project.id}
                ...
                style={isLoneLastRow ? { gridColumn:'2' } : undefined}
              >
